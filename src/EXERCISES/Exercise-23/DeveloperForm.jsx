      ...
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg p-8 ring-1 ring-zinc-900/5">
        ...
        <form onSubmit={handleSubmit} className="space-y-6" noValidate>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {SKILL_OPTIONS.map((skill) => {
                ...
                return (
                  <label key={skill} htmlFor={skillId} className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      id={skillId}
          ...
          <div>
            <div className="flex items-center space-x-2">
              <input
                ...
                className="h-4 w-4 rounded border-zinc-300 text-blue-600 focus:ring-blue-500"
              />
              <label htmlFor="agreeToTerms" className="text-sm text-zinc-700 cursor-pointer">
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="h-4 w-4 rounded border-zinc-300 text-blue-600 focus:ring-blue-500"
            />
            <label htmlFor="notifications" className="text-sm text-zinc-700 cursor-pointer">
          ...
          <button
            type="submit"
            className="w-full rounded-lg bg-rose-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-rose-500 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 transition-colors"
          >
            Submit Application
          </button>
        </form>
        ...
        {submittedData && (
          <div className="mt-6 p-4 bg-emerald-50 border border-emerald-200 rounded-lg">
            <h3 className="text-sm font-semibold text-emerald-800">Application Submitted!</h3>
            <p className="text-xs text-emerald-600 mt-1">
              Thank you, {submittedData.fullName}. Your application for {submittedData.role} has been logged.
            </p>
          </div>
        )}
      </div>
